...
public class CalendarSwingEX extends JFrame implements ActionListener, Serializable{ //serializable 직렬화. 파일로 쓰기 가능해짐
	...
	public void start() { //스타트를 호출해야만 창이 뜨게끔 만듬(dataVO하면서 만듬) 
		setSize(400,300);
		setVisible(true);
	}
